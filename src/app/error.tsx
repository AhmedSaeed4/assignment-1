...
export default function Home() {
  return (
    <div className="grid grid-cols-12 grid-rows-12 gap-5">
      ...
      <div className="bg-ryzen-850  border-solid border-red-600/40 border-2 inline-flex items-center p-5 row-start-4 col-start-5 row-end-7 col-end-9  text-white font-bold backdrop-blur-xl bg-gradient-to-r justify-center rounded-xl from-ryzen-900/20 to-ryzen-900/10 animate-slideleft">error...</div>
