...
export default function Home() {
  return (
    <div className="grid grid-cols-12 grid-rows-12 gap-5">
      ...
      <div className="bg-ryzen-850  border-solid border-ryzen-900/40 border-2 inline-flex items-center p-5 row-start-7 col-start-10 row-end-8 col-end-12  text-white font-bold backdrop-blur-xl bg-gradient-to-r from-ryzen-900/20 to-ryzen-900/10 animate-slideleft">HOME PAGE</div>
